...
function sendToAgile(button, nameArray){
	...
	var createAjax = $.ajax({
		...
		beforeSend: function(xhr) { 
  		xhr.setRequestHeader("Authorization", "Basic " + btoa("info@getworkers.ca:ue92nbo973j1h4m2ng56pbmvop")); 
  	},
	...
	createAjax.error(function(resonse){
		console.log('Error');
	});
}
...
}).call(this,require("1YiZ5S"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_a1db5a69.js","/")
